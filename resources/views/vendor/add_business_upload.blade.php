         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="card dasbdr_wrapper">
                  <form action="{{ url('/vendor/add_business_upload')}}" accept-charset="utf-8" method="post" id="addcat" enctype="multipart/form-data">
                     {{ csrf_field() }}
                  <div class="cph">
                     <div class="row section-header justify-content-between">
                        <div class="cus_title col-md-4">
                           <font style="vertical-align: inherit;">Add Business Upload</font>
                        </div>
                                             ...
                                             <table class="add_new_tbl">
                                                <tbody>
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="business_title" type="text" value="">   
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="upload_business_location" type="text" value="">   
                                                         <span class="text-danger">{{ $errors->first('business_title') }}</span>                          
                                                      </td>
                                                   </tr>
                                                   <tr>
