                  ...
                  <div class="cph">
                     <div class="section-header row">
                        <div class="cus_title col-md-8">
                           <i class="fa fa-sitemap"></i> Feedback List
                                    ...
                                    <table cellspacing="0" class="table cus_tbl table-striped m-0">
                                       <thead class="t-grid-header">
                                          <tr>
                                             ...
                                             <th scope="col"><span class="t-link">User Phone</span></th>
                                             <th scope="col"><span class="t-link">User Feedback</span></th>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td>{{ $row->created_at }}</td>
                                              <td><a href="{{ url('vendor/feedback/view', $row->id )}}">View</a></td>
                                          </tr>
                                          @endforeach
                                       </tbody>
                                    </table>
