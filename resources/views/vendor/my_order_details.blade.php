            ...
            <div class="cph">
               <div class="row section-header justify-content-between">
                  <div class="cus_title col-md-4">
                     <font style="vertical-align: inherit;">My Order Details</font>
                  </div>
               </div>
                                       ...
                                       <table class="add_new_tbl">
                                          <tbody>
                                             <tr>
                                                ...
                                                <td class="adminData">
                                                  ...
                                                  <div>
                                                    ...
                                                    <button type="submit" name="completeorder" id="readytopickup"  data-url="{{ url('vendor/order/readytopickup') }}" data-id="{{$RequestOrder->id}}" class="btn btn-sm btn-warning ask-to-proceed" value="Complete">
                                             ...
                                             <tr>
                                                <td class="adminTitle">
                                                   <div class="ctl-label">
                                                      <label><font style="vertical-align: inherit;">Order Summery</font>
                                                      </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="The name of the specification attribute."><i class="fa fa-question-circle"></i></a>
                                                   </div>
                                                </td>
                                                <td class="adminData">
                                             ...
                                             <tr>
                                                <td class="adminTitle">
                                                   <div class="ctl-label">
                                                      <label><font style="vertical-align: inherit;">Order Date & Time</font>
                                                      </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="The name of the specification attribute."><i class="fa fa-question-circle"></i></a>
                                                   </div>
                                                </td>
                                                <td class="adminData">
...
<script type="text/javascript">
    $(document).ready(function () {
         $('#readytopickup').on('click', function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            setTimeout("window.location.href='http://127.0.0.1:8000/vendor/my_order'",1000);
                        },
                        error: function (data) {
