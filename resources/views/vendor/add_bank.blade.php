         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="card dasbdr_wrapper">
                  <form action="{{ url('/vendor/add_bank')}}" id="addcat" method="post" enctype="multipart/form-data">
                     {{ csrf_field() }}
                  <div class="cph">
                     <div class="row section-header justify-content-between">
                        <div class="cus_title col-md-4">
                           <font style="vertical-align: inherit;">Add Bank</font>
                        </div>
                                             ...
                                             <table class="add_new_tbl">
                                                <tbody>
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="bank_name" type="text" value=""><span class="text-danger">{{ $errors->first('bank_name') }}</span>                                
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td class="adminTitle">
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="branch_name" type="text" value=""><span class="text-danger">{{ $errors->first('branch_name') }}</span>                                
                                                      </td>
                                                   </tr>
                                                   <!-- <tr class="brek"></tr> -->
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="ac_number" type="text" value=""><span class="text-danger">{{ $errors->first('ac_number') }}</span>         
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td class="adminTitle">
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="bank_ifsc_code" type="text" value=""><span class="text-danger">{{ $errors->first('bank_ifsc_code') }}</span>                   
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td class="adminTitle">
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="ac_holder_name" type="text" value=""><span class="text-danger">{{ $errors->first('ac_holder_name') }}</span>                   
                                                      </td>
                                                   </tr>
                                                </tbody>
                                             </table>
