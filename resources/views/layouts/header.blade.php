            ...
            <div class="cus_container header-mid">
               <div class="row mid-wrap">
                  <div class="col brand">
                     ...
                     <a class="logo" href="index.html"><img src="{{'/assets/homecss/images/logo.png'}}" class="img-fluid" alt=""/></a>
                  </div>
                                    ...
                                    <div class="modal-body">
                                        <div class="right-modal-bg">
                                            ...
                                            <form align="center" method="POST" id="otp_verifications">
                                                ...
                                                <div class="form-group">
                                                    <small id="emailHelp" class="form-text text-muted">
                                                      <label for="exampleInputEmail1">Enter the OTP recieved on <span><div id="signup_otp"></div></span></label>
                                                    </small>
