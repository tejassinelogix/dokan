         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="card dasbdr_wrapper">
                  <form id="addcat" action="{{ url('/admin/addproduct')}}" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     <div class="cph">
                                          ...
                                          <table class="add_new_tbl">
                                             <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td class="adminData">
                                                      <select class="selectpicker" name="product_categories[]" multiple title="Choose one of the following..." data-live-search="true">
                                                         ...
                                                         <div class="fileupload-controls">
                                                            <div class="fileupload">
                                                               <div class="fileupload-buttons">
                                                                  <img id="image_preview_container" src="{{ URL::to('/') }}/product_images/image-preview.png" alt="preview image" style="max-height: 150px;">
