                                    ...
                                    <table cellspacing="0" class="table cus_tbl table-striped m-0">
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                   <div class="zoomable-thumb-container"><img alt="{{$row->id}}" src="{{ URL::to('/') }}/vendor_profile/{{ $row->vendor_image }}" class="zoomable-thumb" style="position: relative;"></div>
                                                </td>
                                             <td>{{ $row->name }}</td>
                                             <td>{{ $row->email }}</td>
                                             ...
                                             <td>Yes <span><a href="{{url('/admin/business_upload')}}">Click here to verify and unlock</a></span></td>
                                             @else
                                             <td>Verified</td>
                                             @endif
