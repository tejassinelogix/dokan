                                             ...
                                             <table class="add_new_tbl">
                                                <tbody>
                                                   ...
                                                   <tr>
                                                     <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label for="AllowCustomersToSelectPageSize"><font style="vertical-align: inherit;">Best Seller</font>
                                                            </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="Whether customers can choose the page size from a predefined list of options."><i class="fa fa-question-circle"></i></a>
                                                         </div>
                                                      </td>
                                                     <td class="adminData">
                                                         <select  class="form-control list-box tri-state select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="best_seller">
                                                            <option  value=""></option>
                                                            <option value="1" {{ $product->best_seller == 1 ? 'selected' : '' }}><font style="vertical-align: inherit;">Yes</font>
                                                            </option>
                                                            <option value="0" {{ $product->best_seller == 0 ? 'selected' : '' }}><font style="vertical-align: inherit;">No</font>
                                                            </option>
                                                         </select>
                                                         <i class="fas fa-caret-down sel_dwn-add_new"></i>
                                                      </td>
                                                   ...
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label for="AllowCustomersToSelectPageSize"><font style="vertical-align: inherit;">Most Rating</font>
                                                            </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="Whether customers can choose the page size from a predefined list of options."><i class="fa fa-question-circle"></i></a>
                                                         </div>
                                                      </td>
                                                     <td class="adminData">
                                                         <select  class="form-control list-box tri-state select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="most_rating">
                                                            <option  value=""></option>
                                                            <option value="1" {{ $product->most_rating == 1 ? 'selected' : '' }}><font style="vertical-align: inherit;">Yes</font>
                                                            </option>
                                                            <option value="0" {{ $product->most_rating == 0 ? 'selected' : '' }}><font style="vertical-align: inherit;">No</font>
                                                            </option>
                                                         </select>
                                                         <i class="fas fa-caret-down sel_dwn-add_new"></i>
                                                      </td>
