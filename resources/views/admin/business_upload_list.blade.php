                                    ...
                                    <table cellspacing="0" class="table cus_tbl table-striped m-0">
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td><span class="badge badge-secondary d-none mr-1"></span><a href="{{ URL::to('/') }}/business_upload_document/{{ $row->bank_proof }}" target="_blank">{{ $row->bank_proof }}</a></td>
                                             <td><span class="badge badge-secondary d-none mr-1"></span><a href="{{ URL::to('/') }}/business_upload_document/{{ $row->cr_document }}" target="_blank">{{ $row->cr_document }}</a></td>
                                             <td><span class="badge badge-secondary d-none mr-1"></span><a href="{{ URL::to('/') }}/business_upload_document/{{ $row->merchant_document }}" target="_blank">{{ $row->merchant_document }}</a></td>
                                             <td><span class="badge badge-secondary d-none mr-1"></span><a href="{{ URL::to('/') }}/business_upload_document/{{ $row->trade_document }}" target="_blank">{{ $row->trade_document }}</a></td>
                                             <td><span class="badge badge-secondary d-none mr-1"></span><a href="{{ URL::to('/') }}/business_upload_document/{{ $row->computer_document }}" target="_blank">{{ $row->computer_document }}</a></td>
                                             <td><span class="badge badge-secondary d-none mr-1"></span><a href="{{ URL::to('/') }}/business_upload_document/{{ $row->authorised_document }}" target="_blank">{{ $row->authorised_document }}</a></td>
                                             <td>{{ $row->vendor_id  }}</td>
                                             ...
                                             @endif
                                             <td align="center"><!-- <a href="{{ url('admin/business_upload/active', $row->id )}}">Active</a> / --> <a href="{{ url('admin/business_upload/inactive', $row->vendor_id )}}">lock</a> / <a href="{{ url('admin/business_upload/unlock', $row->vendor_id )}}">Unlock</a></td>
                                          </tr>
                                          @endforeach
                                       </tbody>
                                    </table>
