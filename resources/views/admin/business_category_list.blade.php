                  ...
                  <div class="cph">
                     <div class="section-header row">
                        <div class="cus_title col-md-8">
                           <i class="fa fa-sitemap"></i> Business Categories List
                        ...
                        <div class="options col-md-4 d-flex justify-content-end">
                           <a href="{{ url('admin/add_business_category')}}" class="btn btn-primary">
                        ...
                        <form action="{{ url('/admin/business_category_filter')}}" method="post" >
                           ...
                           <div class="row mt-3 grid-filter">
                              <div class="col-sm-6 col-lg-4 col-xl-3 form-group">
                                 <div class="ctl-label">
                                    <label for="SearchCategoryName">Business Category name</label><a class="hint" href="#" onclick="return false;" tabindex="-1" title="Category" data-toggle="tooltip" data-placement="left"><i class="fa fa-question-circle"></i></a>
                                 </div>
                                    ...
                                    <table cellspacing="0" class="table cus_tbl table-striped m-0">
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td><a href="{{ url('admin/business_category/edit', $row->id )}}">{{ $row->business_category_name }}</a></td>
