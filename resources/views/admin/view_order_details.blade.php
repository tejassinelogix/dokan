                                             ...
                                             <tr>
                                                ...
                                                <td class="adminData">
                                                  ...
                                                  <div>
                                                    ...
                                                    <button type="submit" name="completeorder" id="completeorder"  data-url="{{ url('admin/order/complete') }}" data-id="{{$RequestOrder->id}}" class="btn btn-sm btn-warning ask-to-proceed" value="Complete">
                                                      <i class="fa fa-check"></i>
                                                      <span>Shipment</span>
                                                    </button>
                                                  </div>                                
