         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="card dasbdr_wrapper">
                  <form action="{{ url('/admin/update_business_category',$business_category->id)}}" accept-charset="utf-8" method="post" id="addcat" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     {{ method_field('PATCH') }}
                  <div class="cph">
                                             ...
                                             <table class="add_new_tbl">
                                                <tbody>
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="business_category_name" type="text" value="{{ $business_category->business_category_name }}">   
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <select class="form-control list-box tri-state select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="business_status">
                                                            <option  value=""></option>
                                                            <option value="1" {{ $business_category->business_status == 1 ? 'selected' : '' }}><font style="vertical-align: inherit;">Active</font>
                                                            </option>
                                                            <option value="0" {{ $business_category->business_status == 0 ? 'selected' : '' }}><font style="vertical-align: inherit;">Inactive</font>
                                                            </option>
                                                         </select>
