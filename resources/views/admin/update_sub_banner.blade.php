            ...
            <div class="row">
               <div class="col-xl-12">
                  <div class="card dasbdr_wrapper">
                     <form id="addcat" action="{{ url('/admin/subbanner/update',$banner->id)}}" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     {{ method_field('PATCH') }}
                     <div class="cph">
                                                ...
                                                <table class="add_new_tbl">
                                                   <tbody>
                                                      <tr>
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="subbannertitle_en" type="text" value="{{ $banner->subbannertitle }}">                                
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td class="adminTitle">
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="subbannertitle_ar" type="text" value="{{ $banner->getTranslation('subbannertitle', 'ar') }}">                                
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td class="adminTitle">
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="subbannerdiscription_en" type="text" value="{{ $banner->subbannerdiscription }}">                                
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td class="adminTitle">
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="subbannerdiscription_ar" type="text" value="{{ $banner->getTranslation('subbannerdiscription', 'ar') }}">                                
                                                         </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="subbannerurl" type="text" value="{{ $banner->subbannerurl }}">                                
                                                         </td>
                                                      </tr>
