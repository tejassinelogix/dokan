            ...
            <div class="row">
               <div class="col-xl-12">
                  <div class="card dasbdr_wrapper">
                     <form id="addcat" action="{{ url('/admin/addclientlogo')}}" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     <div class="cph">
                        <div class="row section-header justify-content-between">
                           <div class="cus_title col-md-4">
                              <font style="vertical-align: inherit;">Add Client Logo</font>
                           </div>
                                                ...
                                                <table class="add_new_tbl">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="logo_url" type="text" value="">                                
                                                         </td>
                                                      </tr>  
                                                      <tr>
                                                         <td class="adminTitle">
