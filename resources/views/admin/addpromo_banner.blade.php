            ...
            <div class="row">
               <div class="col-xl-12">
                  <div class="card dasbdr_wrapper">
                     <form id="addcat" action="{{ url('/admin/addpromo_banner')}}" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     <div class="cph">
                        <div class="row section-header justify-content-between">
                           <div class="cus_title col-md-4">
                              <font style="vertical-align: inherit;">Add Promo Banner</font>
                           </div>
                                    ...
                                    <div class="tabbable tabs-left tabs-autoselect row new_horizon_tab_outer">
                                       <div class="col-lg-12 nav-aside">
                                          <ul class="nav nav-tabs nav-tabs-line">
                                             <li class="nav-item"><a href="#tab-1" data-toggle="tab" data-loaded="true" class="nav-link active show"><span class="tab-caption"><font style="vertical-align: inherit;">Promo Banner</font></span></a></li>
                                          </ul>
                                       </div>
                                                ...
                                                <table class="add_new_tbl">
                                                   <tbody>
                                                      <tr>
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="promobanner_title_en" type="text" value="">                                
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td class="adminTitle">
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="promobanner_title_ar" type="text" value="">                                
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td class="adminTitle">
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="promobanner_discription_en" type="text" value="">                                
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td class="adminTitle">
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="promobanner_discription_ar" type="text" value="">                                
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                      <td class="adminTitle">
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="promobanner_url" type="text" value="">                                
                                                         </td>
                                                      </tr>
