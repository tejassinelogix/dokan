         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="card dasbdr_wrapper">
                  <form action="{{ url('/admin/add_business_subcategory')}}" accept-charset="utf-8" method="post" id="addcat" enctype="multipart/form-data">
                     {{ csrf_field() }}
                  <div class="cph">
                     <div class="row section-header justify-content-between">
                        <div class="cus_title col-md-4">
                           <font style="vertical-align: inherit;">Add Business SubCategory</font>
                        </div>
                                             ...
                                             <table class="add_new_tbl">
                                                <tbody>
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="business_subcategory_name" type="text" value="">   
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <select data-val="true" data-val-number="The field 'Badge stil' must be a number." data-val-required="" id="product_categories" name="business_category" tabindex="-1" class="select2-hidden-accessible" aria-hidden="true">
