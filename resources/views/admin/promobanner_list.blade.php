                              ...
                              <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                   <div class="zoomable-thumb-container"><img alt="{{$row->id}}" src="{{ URL::to('/') }}/promo_banner_images/{{ $row->promobanner_images }}" class="zoomable-thumb" style="position: relative;"></div>
                                                </td>
