            ...
            <div class="row">
               <div class="col-xl-12">
                  <div class="card dasbdr_wrapper">
                     <form id="addcat" action="{{ url('/admin/banner/update',$banner->id)}}" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     {{ method_field('PATCH') }}
                     <div class="cph">
                                                ...
                                                <table class="add_new_tbl">
                                                   <tbody>
                                                      <tr>
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="bannertitle_en" type="text" value="{{ $banner->bannertitle }}">                                
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td class="adminTitle">
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="bannertitle_ar" type="text" value="{{ $banner->getTranslation('bannertitle', 'ar') }}">                                
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td class="adminTitle">
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="bannerdiscription_en" type="text" value="{{ $banner->bannerdiscription }}">                                
                                                         </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="bannerdiscription_ar" type="text" value="{{ $banner->getTranslation('bannerdiscription', 'ar') }}">                                
                                                         </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="bannerurl" type="text" value="{{ $banner->bannerurl }}">                                
                                                         </td>
                                                      </tr>
